...
bam="/hlilab/neng/projs/proj-phasing/hg002_revio_mapping/hg002_revio_grch38_minimap2_juncbed.sort.bam"
...
bed="/hlilab/neng/projs/proj-phasing/phase/htslib_rs/anno_eval/hg002_truth/hg002_revio_high_quality_region_10x.bed"
